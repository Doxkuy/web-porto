...
export class Map
{
    ...
    setLocations()
    {
        ...
        this.locations.items = [
            { name: 'Pencapaian', respawnName: 'achievements', offset: { x: 0, y: -0.01 } },
            { name: 'Altar', respawnName: 'altar', offset: { x: 0, y: -0.05 } },
            { name: 'Tentang<br /> Saya', respawnName: 'behindTheScene', offset: { x: 0.01, y: 0 } },
            { name: 'Bowling', respawnName: 'bowling', offset: { x: -0.08, y: 0.03 } },
            { name: 'Karir', respawnName: 'career', offset: { x: 0, y: -0.06 } },
            { name: 'Sirkuit', respawnName: 'circuit', offset: { x: -0.08, y: -0.05 } },
            { name: 'Cookie', respawnName: 'cookie', offset: { x: -0.02, y: -0.01 } },
            { name: 'Lab', respawnName: 'lab', offset: { x: -0.03, y: 0 } },
            { name: 'Pendaratan', respawnName: 'landing', offset: { x: 0.02, y: 0 } },
            { name: 'Proyek', respawnName: 'projects', offset: { x: 0, y: -0.02 } },
            { name: 'Sosial', respawnName: 'social', offset: { x: -0.01, y: -0.04 } },
            { name: 'Mesin Waktu', respawnName: 'timeMachine', offset: { x: 0, y: 0 } },
        ]
